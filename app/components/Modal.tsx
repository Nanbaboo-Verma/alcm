        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-xl overflow-hidden">
          <div className="flex items-start justify-between gap-4 p-4 border-b border-gray-100 dark:border-zinc-800">
            <div className="flex items-center gap-3">
              ...
              {heading && <h3 className="text-lg font-semibold text-black dark:text-gray-100">{heading}</h3>}
            </div>
            ...
            {showCloseButton && (
              <button
                onClick={onClose}
                aria-label="Close"
                className="cursor-pointer rounded-md p-1 hover:bg-gray-100 dark:hover:bg-zinc-800"
              >
                <X />
              </button>
            )}
          ...
          <div className="p-4 md:p-5 overflow-auto h-[calc(100vh - 100px)]" style={{maxHeight: 'calc(100vh - 100px)'}}>
            {children}
          </div>
